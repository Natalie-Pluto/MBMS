...
public class ListSeats {
    public static void listSeats(Database db, String cinemaName, String movieName, String screenType, String startTime){
        ...
        System.out.println("======================================================");
        System.out.println(PURPLE_BOLD + "Please select your seatLocation:");
        System.out.println("======================================================\n");
        System.out.println("1.Front: " + (frontNum - frontBooked) + "seats left");
        System.out.println("2.Mid: " + (midNum - midBooked) + " seats left");
        System.out.println("3.Back: " + (backNum - backBooked) + " seats left");
    }
